...
public class GetPopulationTask extends RecursiveTask<Integer> {
    ...
    public GetPopulationTask(CensusGroup[] censusGroups, MapCorners corners, int lo, int hi, double w,
                             double s, double e, double n, int rows, int cols, int CUTOFF) {
    ...
    protected Integer compute() {
        ...
        GetPopulationTask left = new GetPopulationTask(censusGroups, corners, lo, mid, w, s, e, n, rows, cols,SEQUENTIAL_CUTOFF);
        GetPopulationTask right = new GetPopulationTask(censusGroups, corners, mid, hi, w, s, e, n, rows, cols,SEQUENTIAL_CUTOFF);
